...
if __name__ == "__main__":
    ...
    combined_df.fillna({
        'Price': 0,  # If price is missing, default to 0
        'Beds': 0,   # If beds are missing, default to 0
        'Baths': 0,  # If baths are missing, default to 0
        'Sqft': 0    # If square footage is missing, default to 0
    }, inplace=True)
